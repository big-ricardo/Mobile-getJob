                        ...
                        users.map((usera, index) => (
                            <View key={usera._id} style={[styles.card, { zIndex: users.length - index }]}>
                                ...
                                <View style={styles.footer}>
                                    <View style={styles.containerText}><Text style={styles.textN}>Nome:</Text><Text style={styles.text}> {usera.name}</Text></View>
                                    <View style={styles.containerText}><Text style={styles.textN}>Usuario:</Text><Text style={styles.text}> {usera.user}</Text></View>
                                    <View style={styles.containerText}><Text style={styles.textN}>Nº Repositorios:</Text><Text style={styles.text}> {usera.repositorios}</Text></View>
