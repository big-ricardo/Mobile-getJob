...
export default function Login({ navigation }) {
    ...
    const [idloggedUser, setIdLogged] = useState('5d8c042f9d03a60017566c14')
    const [idtargetUser, setTIdarget] = useState('5d63104c4d084d2ed4fd7d75')
    let mss = []
    ...
    async function loadUsers() {
        ...
        AsyncStorage.getItem('devId').then(vaga => {
            setTIdarget(vaga)
            async function carregaUser() {
